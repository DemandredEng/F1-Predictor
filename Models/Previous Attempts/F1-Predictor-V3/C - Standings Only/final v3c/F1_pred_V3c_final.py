...
def objective_mlp(trial):
    ...
    mlp_model.fit(xv3c_train, y_train)
    scores = -cross_val_score(mlp_model, xv3c_train, y_train, cv=tscv, scoring='neg_root_mean_squared_error')
    return scores.mean()
...
MLP_Predictor(test21, xv3c_test21, 'MLP v3c, 2021')
MLP_Predictor(test22, xv3c_test22, 'MLP v3c, 2022')

print(model_performance)
model_performance.to_excel('Model_Performance_V3c_Final.xlsx', index=False)