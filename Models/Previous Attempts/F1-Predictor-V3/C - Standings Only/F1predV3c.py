...
'''
best_n_estimators = 505
best_max_features = 0.23229526826100122
best_max_depth = 13
...
best_gamma = 0.005652449108523013
best_C = 0.2289159818361862
best_kernel = 'rbf'
...
model_performance.to_excel('Model_PerformanceV3c.xlsx', index=False)
print(model_performance)